                    ...
                    children: [
                        ...
                        children: [
                          Column(
                            children: [
                              ...
                              Text(
                                "1 porsi (${widget.recipeItems.weight}g)",
                                style: const TextStyle(
                                  fontSize: 13,
                      ...
                      Row(
                        ...
                        children: List.generate(
                          widget.recipeItems.ingredients.length,
                          (index) => Column(
                            children: [
                              CircleAvatar(
                                radius: 30,
                                backgroundColor:
                                    widget.recipeItems.ingredients[index].color,
                                child: Image.asset(
                                  widget.recipeItems.ingredients[index].image,
                                  height: 40,
                                  width: 40,
                                ),
                              ),
                              const SizedBox(height: 5),
                              Text(
                                widget.recipeItems.ingredients[index].name,
                                style: const TextStyle(
                                  fontSize: 12,
                                  fontWeight: FontWeight.bold,
